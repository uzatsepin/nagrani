<template>
    ...
    <main class="public-offer-page">
        <div class="container">
            <div class="public-offer-content" v-if="data?.data">
...
const { data, status, error } = await useFetch<PublicOfferResponse>('/api/directus/items/publichna_oferta', {
    server: true,
    headers: {
...
useSeoMeta({
    title: 'Публічна оферта - NaGrani',
    description: 'Публічний договір (оферта) на замовлення, купівлю-продаж та доступ до онлайн-курсів та інформаційних матеріалів від NaGrani.',
    ogTitle: 'Публічна оферта - NaGrani',
    ogDescription: 'Публічний договір (оферта) на замовлення, купівлю-продаж та доступ до онлайн-курсів та інформаційних матеріалів від NaGrani.',
    ogImage: '/images/og-image.jpg',
    ogUrl: 'https://nagrani.life/publichna-oferta',
    ...
    script: [
        {
            ...
            innerHTML: JSON.stringify({
                ...
                description: 'Публічний договір (оферта) на замовлення, купівлю-продаж та доступ до онлайн-курсів та інформаційних матеріалів',
                url: 'https://nagrani.life/publichna-oferta',
                inLanguage: 'uk-UA',
                isPartOf: {
                    '@type': 'WebSite',
                    name: 'NaGrani',
